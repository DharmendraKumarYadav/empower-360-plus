...
export class ExpenseBookingModel{
    ...
    constructor(id?: string, subCategoryItemId?: string, fromDate?: string, toDate?: string, amount?: string, departmentId?: string, department?: string, subCategoryItem?: string
